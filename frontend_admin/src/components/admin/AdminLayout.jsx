...
export default function AdminLayout({ children }) {
  ...
  const sections = [
    { label: "Header", href: "/admin/landing/header" },
    { label: "Hero", href: "/admin/landing/hero" },
    { label: "Features", href: "/admin/landing/features" },
    { label: "Planes", href: "/admin/landing/planes" },
    { label: "Testimonials", href: "/admin/landing/testimonials" },
        ...
        >
          ...
          <div className="border-t border-white/10 p-3">
            <button
              ...
              className={`flex w-full items-center rounded-2xl px-4 py-3 text-sm text-white/85 transition hover:bg-white/10 ${
