...
export function PricingSection({ plans = [], config = {} }) {
  ...
  return (
    <section
      id="pricing"
      className="relative isolate overflow-hidden bg-[#eef4fb] py-24 text-[var(--balto-midnight)] sm:py-10"
    >
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(0,85,187,0.21),transparent_34%),radial-gradient(circle_at_bottom_left,rgba(10,37,64,0.14),transparent_36%),linear-gradient(180deg,#ffffff_0%,#f7f9fc_42%,#eef4fb_100%)]" />
        <div className="absolute left-1/2 top-20 h-80 w-80 -translate-x-1/2 rounded-full bg-[rgba(0,85,187,0.21)] blur-[120px]" />
        <div className="absolute bottom-0 left-0 h-72 w-72 rounded-full bg-[rgba(10,37,64,0.14)] blur-[115px]" />
        <div className="absolute right-0 top-1/3 h-64 w-64 rounded-full bg-[rgba(0,85,187,0.17)] blur-[110px]" />
        <div className="absolute inset-0 opacity-[0.075] [background-image:linear-gradient(rgba(10,37,64,0.60)_1px,transparent_1px),linear-gradient(90deg,rgba(10,37,64,0.60)_1px,transparent_1px)] [background-size:44px_44px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-6 text-3xl font-semibold tracking-[-0.04em] text-[var(--balto-midnight)] sm:text-5xl">
            {title}
          </h2>

          <p className="mx-auto mt-5 text-[15px] leading-7 text-slate-700 sm:text-base">
            {description}
          </p>
        </motion.div>
              ...
              return (
                <motion.article
                  ...
                  className={`group relative flex h-full flex-col overflow-hidden rounded-[32px] border p-7 transition duration-300 hover:-translate-y-2 sm:p-8 ${
                    featured
                      ? "border-[rgba(0,85,187,0.52)] bg-[linear-gradient(180deg,#ffffff_0%,#e3f0ff_48%,#ffffff_100%)] shadow-[0_0_0_1px_rgba(0,85,187,0.20),0_32px_86px_rgba(0,85,187,0.25)]"
                ...
                >
                  {featured && (
                    <>
                      <div className="pointer-events-none absolute inset-x-10 top-0 h-24 rounded-full bg-[rgba(0,85,187,0.28)] blur-3xl" />

                      <div className="absolute right-6 top-6 z-20">
                        <span className="inline-flex items-center gap-2 rounded-full border border-[rgba(0,85,187,0.26)] bg-[var(--balto-action)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white shadow-[0_12px_28px_rgba(0,85,187,0.26)]">
                  ...
                  <div className="pointer-events-none absolute inset-0 rounded-[32px] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),transparent_28%,transparent_76%,rgba(0,85,187,0.07))]" />
                  ...
                  <div className="relative z-10 flex h-full flex-col">
                    <div >
                      ...
                      <h3 className="mt-5 text-2xl font-semibold tracking-tight text-[var(--balto-midnight)]">
                        {plan.name}
                      </h3>
                    ...
                    <div className="mt-0 rounded-[24px] border border-[rgba(0,85,187,0.24)] bg-[rgba(0,85,187,0.10)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
                      {plan.price ? (
                        <>
                    ...
                    <a
                      ...
                      className={`mt-9 inline-flex w-full items-center justify-center gap-2 rounded-2xl px-4 py-3.5 text-sm font-medium transition duration-300 ${
                        featured
                          ? "bg-[var(--balto-action)] text-white shadow-[0_16px_38px_rgba(0,85,187,0.24)] hover:-translate-y-0.5 hover:bg-[var(--balto-midnight)]"
